...
function buildChatbotSystemPrompt(role) {
    const roleContext = role === "delivery"
...
function buildChatbotConversation(messages, role) {
    return [
        { role: "system", content: buildChatbotSystemPrompt(role) },
...
export function createApp() {
    ...
    app.post("/api/chatbot/assist", chatbotLimiter, async (request, response) => {
